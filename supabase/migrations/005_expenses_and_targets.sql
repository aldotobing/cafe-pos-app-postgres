...
CREATE TABLE IF NOT EXISTS expenses (
    ...
    -- Payment Method
    payment_method payment_method DEFAULT 'Tunai',
...
CREATE TABLE IF NOT EXISTS revenue_targets (
    ...
    -- Target Period
    target_date DATE,                    -- For daily targets (optional)
    ...
    -- Target Values
    daily_target NUMERIC DEFAULT 0 CHECK (daily_target >= 0),       -- Target per day
    monthly_target NUMERIC DEFAULT 0 CHECK (monthly_target >= 0),   -- Target per month
...
-- ============================================
INSERT INTO expense_categories (name, color, description, sort_order) VALUES
('Gaji Karyawan', '#10B981', 'Pembayaran gaji karyawan cafe', 1),
('Sewa Tempat', '#F59E0B', 'Biaya sewa tempat/bangunan', 2),
('Listrik & Air', '#3B82F6', 'Tagihan listrik dan air', 3),
('Bahan Baku', '#EF4444', 'Pembelian bahan baku untuk produksi', 4),
('Perawatan', '#8B5CF6', 'Biaya perawatan peralatan dan fasilitas', 5),
('Marketing', '#EC4899', 'Biaya promosi dan marketing', 6),
('Transportasi', '#6366F1', 'Biaya transportasi dan pengiriman', 7),
('Lainnya', '#6B7280', 'Pengeluaran lainnya', 99);

...
import { LayoutGrid, Settings, ShoppingCart, History, TrendingUp, BarChart3, Package, FolderOpen, ShoppingBag, Warehouse, ShieldCheck, Users, Building2, Wallet, BadgePercent } from "lucide-react"
...
const links: LinkItem[] = [
  ...
  { href: "/promotions", label: "Promosi", icon: BadgePercent, hiddenForRoles: ['cashier'] },
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 max-w-7xl mx-auto w-full">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <NotificationBell cafeId={cafeId} />
